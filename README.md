...
这是一个专为 OpenClaw 框架开发的波场（TRON）能量租赁与转账手续费优化 Skill 插件。通过接入本插件，您的机器人或系统可实现 24 小时无人值守、秒级自动调用网络资源，大幅降低智能合约交易成本。

## 🌐 核心功能与官方接口
* **自动资源调用**：支持波场网络能量与带宽的秒级快速租赁。
* **手续费优化**：相比直接使用波场钱包转账，可节省高达 70% 的手续费。
* **API 无缝对接**：完美兼容 OpenClaw 框架，一键配置即可运行。
